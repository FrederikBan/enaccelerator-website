  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await fetch(form.action, {
        method: form.method,
        body: formData,
        mode: 'no-cors' // MailerLite expects this for public form posts
      });

      // Show the success message
      ml_webform_success_26946439();
    } catch (error) {
    ...
    <section className="bg-brand-yellow py-20">
      <div className="container text-center">
        <div className="max-w-3xl mx-auto">
          <div className="ml-form-embedContainer ml-subscribe-form ml-subscribe-form-26946439">
